...
fun AlertDialog.Builder.createAlertWithPositiveButton (title: String = "", message:String, positiveText :String ,
...
fun AlertDialog.Builder.createAlertWithTwoButtons (title: String = "", message:String, positiveText :String ,
